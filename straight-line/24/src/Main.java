...
public class Main {
    ...
    public static javax.swing.text.Element getParagraphElement(javax.swing.text.Document arg0, int arg1) {
        return (javax.swing.text.Element) request.newBatchInvocation(0)
                 .addDeclaringClassesFromPrefix("javax.swing.text")
                 .addDeclaringClasses(javax.swing.text.Document.class, javax.swing.text.Element.class)
                 .addArgument(javax.swing.text.Document.class, "arg0", arg0)
                 .addArgument(int.class, "arg1", arg1)
                 .setReturnType(javax.swing.text.Element.class)
                 .setMaxSearchDepth(3)
                 .invoke();
    }
