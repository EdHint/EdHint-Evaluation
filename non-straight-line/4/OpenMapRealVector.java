...
public class OpenMapRealVector extends AbstractRealVector
    ...
    public OpenMapRealVector ebeDivide(RealVector v) {
        ...
        /*while (iter.hasNext()) {
            iter.advance();
            res.setEntry(iter.key(), divideVal(iter, v));
        }*/
        int i = 0;
        while ((Boolean) request.newBatchInvocation(0)
            ...
            request.newBatchInvocation(1)
                .addDeclaringClasses(Iterator.class, OpenMapRealVector.class)
                .addArgument(Iterator.class, "iter", iter)
                .addArgument(OpenMapRealVector.class, "res", res)
                .addArgument(RealVector.class, "v", v)
    ...
    public double divideVal(Iterator iter, RealVector v) {
