...
public class CollapseProperties implements CompilerPass {
  ...
  private void flattenReferencesToCollapsibleDescendantNames(
    ...
    for (Name p : n.props) {
      ...
      if ((Boolean)request.newBatchInvocation(0)
            .addDeclaringClasses(Name.class)
	    .addArgument(Name.class, "p", p)
	    .setReturnType(boolean.class)
            .setMaxSearchDepth(1)
	    .invoke()) {
        request.newBatchInvocation(1)
            .addDeclaringClasses(CollapseProperties.class)
	    .addArgument(Name.class, "p", p)
	    .addArgument(String.class, "propAlias", propAlias)
	    .addArgument(CollapseProperties.class, "this", this)
   ...
   */
  public void flattenSimpleStubDeclaration(Name name, String alias) {
   ...
   */
  public void flattenReferencesTo(Name n, String alias) {
