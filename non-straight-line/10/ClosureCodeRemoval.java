 ...
 */
final public class ClosureCodeRemoval implements CompilerPass {
  ...
  private class RemovableAssignment {
    ...
    public void remove() {
      ...
      for (Node ancestor : assignAncestors) {
		...
		.addArgument(Node.class, "ancestor", ancestor)
		...
		.invoke()) {
    	  request.newBatchInvocation(1)
                .addDeclaringClasses(Node.class)
 	        .addArgument(Node.class, "ancestor", ancestor)
  		.addArgument(Node.class, "lastAncestor", lastAncestor)
 		...
 		.invoke();
          ...
          request.newBatchInvocation(2)
                .addDeclaringClasses(Node.class)		 
                .addArgument(Node.class, "ancestor", ancestor)
	        .addArgument(Node.class, "rhs", rhs)
		.addArgument(Node.class, "last", last)
		.setReturnType(void.class)
                .setMaxSearchDepth(2)
		.invoke();
        }
