...
public class OpenMapRealVector extends AbstractRealVector
    ...
    public OpenMapRealVector add(OpenMapRealVector v) {
        ...
        /*while (iter.hasNext()) {
            ...
            if (randomAccess.containsKey(key)) {
                res.setEntry(key, addVal(randomAccess, iter, key));
            } else {
                res.setEntry(key, iter.value());
            }
        }*/
        int i = 0;
	while ((Boolean) request.newBatchInvocation(0)
                .addDeclaringClasses(Iterator.class)
		.addArgument(Iterator.class, "iter", iter)
		...
		.invoke()) {		
            ...
            int key = (Integer) request.newBatchInvocation(1)
                .addDeclaringClasses(Iterator.class)
                .addArgument(Iterator.class, "iter", iter)
                .setReturnType(int.class)
                .setMaxSearchDepth(2)
                .invoke();
            if ((Boolean) request.newBatchInvocation(2)
                    .addDeclaringClasses(OpenIntToDoubleHashMap.class)
                    .addArgument(OpenIntToDoubleHashMap.class, "randomAccess", randomAccess)
                    .addArgument(int.class, "key", key)
                    .setReturnType(boolean.class)
                    .setMaxSearchDepth(1)
                    .invoke()) {
                request.newBatchInvocation(3)
                    .addDeclaringClasses(OpenMapRealVector.class)
                    .addArgument(OpenMapRealVector.class, "res", res)
                    .addArgument(int.class, "key", key)
                    .addArgument(Iterator.class, "iter", iter)
                    .addArgument(OpenIntToDoubleHashMap.class, "randomAccess", randomAccess)
    ...
    public static double addVal(OpenIntToDoubleHashMap randomAccess, Iterator iter, int key) {
        return randomAccess.get(key) + iter.value();
    }
