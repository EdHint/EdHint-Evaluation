...
public abstract class Axis implements Cloneable, Serializable {
    ...
    protected void createAndAddEntity(double cursor, AxisState state,
        ...
        if ((Boolean) request.newBatchInvocation(0)
                        .addDeclaringClasses( RectangleEdge.class)
                        .addArgument(RectangleEdge.class, "edge", edge)
                        .addArgument(RectangleEdge.class, "RectangleEdge.TOP", RectangleEdge.TOP)
        ...
        else if ((Boolean) request.newBatchInvocation(1)
                .addDeclaringClasses( RectangleEdge.class)
                .addArgument(RectangleEdge.class, "edge", edge)
                .addArgument(RectangleEdge.class, "RectangleEdge.BOTTOM", RectangleEdge.BOTTOM)
                .setReturnType(boolean.class)
                .setMaxSearchDepth(1)
                .invoke()) {            
            hotspot  = ( Rectangle2D.Double) request.newBatchInvocation(2)
                    .addDeclaringClasses(Rectangle2D.class,AxisState.class,Rectangle2D.Double.class)
                    .addArgument(double.class, "cursor", cursor)
                    .addArgument(AxisState.class, "state", state)
                    .addArgument(Rectangle2D.class, "dataArea", dataArea)
                    .addArgument(double.class, "state.getCursor() - cursor", state.getCursor() - cursor)
                    .setReturnType(Rectangle2D.Double.class)
                    .setMaxSearchDepth(3)
                    .invoke();
        }
        else if ((Boolean) request.newBatchInvocation(3)
                .addDeclaringClasses( RectangleEdge.class)
                .addArgument(RectangleEdge.class, "edge", edge)
                .addArgument(RectangleEdge.class, "RectangleEdge.LEFT", RectangleEdge.LEFT)
                .setReturnType(boolean.class)
                .setMaxSearchDepth(1)
                .invoke()) {        	
            hotspot = new Rectangle2D.Double(state.getCursor(),
