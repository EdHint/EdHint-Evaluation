...
public class OpenMapRealVector extends AbstractRealVector
    ...
    public static sketch4j.request.invocation.BatchInvocationRequest request = new sketch4j.request.invocation.BatchInvocationRequest();
    ...
    public OpenMapRealVector append(OpenMapRealVector v) {
        ...
        while((Boolean) request.newBatchInvocation(0)
            ...
            request.newBatchInvocation(1)
                ...
                .setMaxSearchDepth(1)
                .invoke();
            request.newBatchInvocation(2)
                .addDeclaringClasses(OpenMapRealVector.class, Iterator.class)
                .addArgument(int.class, "iter.key() + virtualSize", iter.key() + virtualSize)
                .addArgument(Iterator.class, "iter", iter)
