...
//                }
    ...
    public void addBaseTimelineException(long domainValue) {
        ...
        Segment baseSegment = (Segment) request.newBatchInvocation(0)
            .addDeclaringClasses(SegmentedTimeline.class)
            .addArgument(SegmentedTimeline.class, "this.baseSegment", this.baseTimeline)
            .addArgument(long.class, "domainValue", domainValue)
            .setReturnType(Segment.class)
            .setMaxSearchDepth(1)
            .invoke();
        // if (baseSegment.inIncludeSegments()) {
        if ((Boolean) request.newBatchInvocation(1)
                .addDeclaringClasses(Segment.class)
                .addArgument(Segment.class, "baseSegment", baseSegment)
            ...
            Segment segment = (Segment) request.newBatchInvocation(2)
                .addDeclaringClasses(Segment.class, SegmentedTimeline.class)
                .addArgument(Segment.class, "baseSegment", baseSegment)
                .addArgument(SegmentedTimeline.class, "this", this)
                .setReturnType(Segment.class)
                .setMaxSearchDepth(2)
                .invoke();
            int i = 0;
