 ...
 *
 */
public class CoalesceVariableNames extends AbstractPostOrderCallback implements
  ...
  private void removeVarDeclaration(Node name) {
   ...
   /* if (NodeUtil.isForIn(parent)) {
    ...
    if ((Boolean)request.newBatchInvocation(0)
            .addDeclaringClasses(NodeUtil.class)
	    .addArgument(Node.class, "parent", parent)
	    .setReturnType(boolean.class)
            .setMaxSearchDepth(1)
	    .invoke()) {
      request.newBatchInvocation(1)
            .addDeclaringClasses(Node.class)
	    .addArgument(Node.class, "var", var)
	    .addArgument(Node.class, "parent", parent)
	    .addArgument(Node.class, "name", name)
	    .setReturnType(void.class)
            .setMaxSearchDepth(2)
	    .invoke(); 
    } else if ((Boolean)request.newBatchInvocation(2)
            .addDeclaringClasses(Node.class)
	    .addArgument(Node.class, "var", var)
	    .setReturnType(boolean.class)
            .setMaxSearchDepth(1)
	    .invoke()) {
      if ((Boolean)request.newBatchInvocation(3)
            .addDeclaringClasses(Node.class)
	    .addArgument(Node.class, "name", name)
	    .setReturnType(boolean.class)
            .setMaxSearchDepth(1)
	    .invoke()) {
        Node value = (Node) request.newBatchInvocation(4)
            .addDeclaringClasses(Node.class)
            .addArgument(Node.class, "name", name)
            .setReturnType(Node.class)
            .setMaxSearchDepth(1)
            .invoke();
