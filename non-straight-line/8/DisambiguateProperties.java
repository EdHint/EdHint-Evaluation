...
public class DisambiguateProperties<T> implements CompilerPass {
  ...
  public class Property {
    ...
    public void addTypeToSkip(T type) {
  ...
  private class FindExternProperties extends AbstractScopingCallback {
    @Override public void visit(NodeTraversal t, Node n, Node parent) {
      ...
      if ((Boolean) request.newBatchInvocation(0)
              .addDeclaringClasses(TypeSystem.class)
	      .addArgument(TypeSystem.class, "typeSystem", typeSystem)
	      .addArgument(Object.class, "type", type)
	      .setReturnType(boolean.class)
              .setMaxSearchDepth(1)
	      .invoke()) {
        request.newBatchInvocation(1)
            .addDeclaringClasses(Property.class)
       	    .addArgument(Property.class, "prop", prop)
      	    .setReturnType(boolean.class)
            .setMaxSearchDepth(1)
   	    .invoke();
      } else {
        request.newBatchInvocation(2)
            .addDeclaringClasses(Property.class)
       	    .addOptionalArgument(Property.class, "prop", prop)
   	    .addArgument(Object.class, "type", type)
